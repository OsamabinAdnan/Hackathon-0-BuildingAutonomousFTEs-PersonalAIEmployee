"""
Watchers package for AI Employee (Gold Tier).
...
- FacebookWatcher: Monitors Facebook Page → /Needs_Action/facebook/
...
Usage:
    ...
    python -m watchers.facebook         # Facebook only
    python -m watchers --watcher facebook  # Facebook via CLI
"""
