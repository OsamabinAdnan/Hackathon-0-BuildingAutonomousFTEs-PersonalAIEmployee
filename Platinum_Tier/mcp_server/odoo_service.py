...
class OdooService:
    ...
    # ==========================================
    # PLATINUM TIER - Create Draft Invoice
    # ==========================================
    async def create_invoice_draft(
        ...
        """
        Create a draft invoice in Odoo (for Platinum Tier draft_only mode).
        ...
        try:
            ...
            # Create invoice in DRAFT state explicitly
            invoice_vals = {
                'move_type': invoice_type,
                'partner_id': partner_id,
                'invoice_date': datetime.now().strftime('%Y-%m-%d'),
                ...
                'state': 'draft'  # Explicitly create as draft
            }
            ...
            logger.info(f'Draft invoice created: {invoice_id} for {partner_name}')
